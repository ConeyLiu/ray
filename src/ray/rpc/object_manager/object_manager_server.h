 ...
 protected:
  ...
  void InitServerCallFactories(
    ...
    std::unique_ptr<ServerCallFactory> push_call_factory(
        new ServerCallFactoryImpl<ObjectManagerService,
                                     ObjectManagerServiceHandler,
                                     PushRequest,
                                     PushReply>(
            service_,
            &ObjectManagerService::AsyncService::RequestPush,
            service_handler_,
            &ObjectManagerServiceHandler::HandlePushRequest,
            cq,
            main_service_));
    server_call_factories_and_concurrencies->emplace_back(std::move(push_call_factory), 5);
    ...
    std::unique_ptr<ServerCallFactory> pull_call_factory(
        new ServerCallFactoryImpl<ObjectManagerService,
                                     ...
                                     PullReply>(
            service_,
            &ObjectManagerService::AsyncService::RequestPull,
            service_handler_,
            &ObjectManagerServiceHandler::HandlePullRequest,
            cq,
            main_service_));
    server_call_factories_and_concurrencies->emplace_back(std::move(pull_call_factory), 5);
    ...
    std::unique_ptr<ServerCallFactory> free_objects_call_factory(
        new ServerCallFactoryImpl<ObjectManagerService,
                                     ...
                                     FreeObjectsReply>(
            service_,
            &ObjectManagerService::AsyncService::RequestFreeObjects,
            service_handler_,
            &ObjectManagerServiceHandler::HandleFreeObjectsRequest,
            cq,
            main_service_));
    server_call_factories_and_concurrencies->emplace_back(std::move(free_objects_call_factory), 2);
  }
